---
title: Claude Code 完整培训教程：从入门到精通
date: 2026-03-20 22:38:00
tags: [AI, Claude Code, 编程工具]
categories: AI工具
---

# Claude Code 完整培训教程：从入门到精通
...
1. [Claude Code 是什么](#一claude-code-是什么)
2. [安装与环境配置](#二安装与环境配置)
3. [斜杠命令全解析](#三斜杠命令全解析)
4. [键盘快捷键速查表](#四键盘快捷键速查表)
5. [Plan 模式深度应用](#五plan-模式深度应用)
6. [OpenSpec：规范驱动开发](#六openspec详细配置)
7. [CC Switch：多服务提供商管理神器](#七cc-switch多服务提供商管理神器)
8. [终端美化：Oh My Posh + PSReadLine](#八终端美化oh-my-posit--psreadline)
9. [高级扩展功能](#九高级扩展功能)
10. [隐藏命令大揭秘](#十隐藏命令大揭秘)
11. [实战技巧与最佳实践](#十一实战技巧与最佳实践)
12. [配置文件体系](#十二配置文件体系)
