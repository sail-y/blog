...
categories: AI工具
description: 对比 OpenSpec、Superpowers、Get Shit Done、Spec-Kit 四大 SDD 技能包的特点和适用场景，帮你选择合适的 SDD 实现方案。
---
...
sequenceDiagram
    ...
    U->>AI: 帮我添加用户认证功能
    AI->>AI: 直接生成代码...
    Note over AI: 理解成 JWT？Session？OAuth？
    Note over AI: 实现了登录，忘记注册
...
这四个都是 Skills（技能包），都实现了 SDD 理念，但在实现方式和侧重点上有所不同。
...
根据项目类型和团队规模选择合适的工具，让你的团队拥抱 SDD，提升开发效率和代码质量。
